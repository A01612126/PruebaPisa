...
def seccion_esp():
    access=""
    while access!="f":
        print('''Menú:  Sección de español.
        Para poder lograr una buena calificación en su prueba PISA, en la sección de español, es necesario practicar.
        Y la comprensión lectora, es un gran componente de esta sección, así que a continuación
        se presentan problemas que ayudaran a mejorar tu desempeño en esta área.''')
